//
//  JHOOfertaInstitucionalViewController.m
//  ProcesAgro
//
...
@interface JHOOfertaInstitucionalViewController (){
     NSMutableArray *vectorConvocatorias;
}

@end

@implementation JHOOfertaInstitucionalViewController
...
- (void) cargarConvocatorias{
    ...
    if (sqlite3_open([appDelegate.dataBasePath UTF8String], &dataBase)== SQLITE_OK) {
        ...
        NSString *sql= [NSString stringWithFormat:@"select * from pasos_ofertas"];
